...
After that we handle the edge case where the list is empty. This is actually not required since the constraints tell us that the list will have atleast the length 1. 
```python
if not gain:
    return 0
```
