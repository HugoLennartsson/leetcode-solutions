...
Then we start processing the tree, starting at the root. When our stack is empty and we do not have current node we are processing we know that we have processed the entire tree.
